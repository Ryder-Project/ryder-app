    ...
    <>
      ...
      <div className="bg-white shadow-md mt-20 p-8 mx-auto max-w-lg">
        <div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="max-w-md mx-auto my-[30px]">
            {/* Pickup Location */}
            <div className="mb-4 px-[32px]">
              <label htmlFor="pickupLocation" className="block text-gray-700 text-sm font-normal mb-2 mr-[200px]">
                Pickup Location
              </label>
              <input
                type="text"
            ...
            <div className="mb-4 px-[32px]">
              <label htmlFor="dropOffPhoneNumber" className="block text-gray-700 text-sm font-normal mb-2 mr-[200px]">
                Drop-off Phone Number
              </label>
              <input
                type="tel"
